...
class TrainerVariationalTS(TrainerTeacherStudent):
    ...
    def loss(self, y, gt, mu, logvar, batch_size=64):
        recon_loss = self.teacher_args.criterion(gt, y) / batch_size
    ...
    def test_teacher(self, mode='test'):
        ...
        for idx, (data_y, data_x) in enumerate(loader, 0):
            ...
            loss, kl_loss, recon_loss = self.loss(output, data_y, mu, logvar, 1)
